  ...
  return (
    <div className='w-full bg-whiteText sticky top-0 z-50'>
      <div className='max-w-screen-xl mx-auto h-20 flex items-center justify-between px-4 lg:px-0'>
        <Link to={'/'}>
          <img src='/src/assets/hippo.png' alt='logo' className='w-60' />
        </Link>
        ...
        <div className='flex items-center gap-x-6 text-2xl'>
          ...
          <Link to={'/favorite'} className='relative block'>
            <FiStar className='hover:text-goldText duration-200 cursor-pointer' />
      ...
      <div className='w-full bg-orange-600 text-whiteText'>
        <Container className='py-2 max-w-4xl flex items-center gap-5 justify-between'>
          <Menu>
            <MenuButton className='inline-flex items-center gap-2 rounded-md border border-white hover:bg-gray-600 py-1.5 px-3 text-sm/6 font-semibold text-white hover:text-white'>
              Select Category
            ...
            >
              <MenuItems
                anchor='bottom end'
                className='w-52 origin-top-right rounded-xl border border-white/5 bg-gray-700 p-1 text-sm/6 text-gray-300 [--anchor-gap:var(--spacing-1)] focus:outline-none hover:text-white z-50'
              >
